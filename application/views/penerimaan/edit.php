    ...
    <div class="col-sm-8">
        ...
        <form action="<?= base_url('penerimaan/edit'); ?>" method="post">
            <div class="form-group">
                <label for="exampleFormControlInput1">Edit Penerimaan Barang</label>
                <input type="hidden" name="id" value="<?= $brg['id']; ?>"">
                <div class=" form-group row">
                <label class="col-sm-3 col-form-label">Tanggal Pembukuan</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control mb-1 datepicker" data-provide="datepicker" id="tgl_pene" name="tgl_pene" placeholder="Tanggal Pembukuan" autocomplete="off" value="<?= $brg['tgl_pene']; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">Dari (Nama Rekanan)</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control mb-1" id="dari" name="dari" placeholder="Nama Toko/Rekanan" value="<?= $brg['dari']; ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="input-group mb-3">
                        <select class="custom-select" id="inputGroupSelect02" name="sumber">
                            <option value="<?= $brg['sumber']; ?>" selected><?= $brg['sumber']; ?></option>
            ...
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">No Dokumen Pengadaan</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control mb-1" id="no_doc_peng" name="no_doc_peng" placeholder="No Dokumen Faktur" value="<?= $brg['no_doc_peng']; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">Tanggal Dokumen Pengadaan</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control mb-1 datepicker" data-provide="datepicker" id="tgl_doc_peng" name="tgl_doc_peng" placeholder="Tanggal Dokumen Faktur" autocomplete="off" value="<?= $brg['tgl_doc_peng']; ?>">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control mb-1" id="vol" name="vol" placeholder="Volume" autocomplete="off" value="<?= $brg['volume']; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">Harga Satuan</label>
                <div class="col-sm-9">
                    <input type=" text" class="form-control mb-1" id="harga" name="harga" placeholder="Masukkan Harga(angka)" value="<?= $brg['harga']; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">Jumlah Harga</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control mb-1" id="total" name="total" placeholder="Total" value="<?= $brg['total']; ?>" readonly>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">No Bukti Penerimaan</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control mb-1" id="no_buk_pen" name="no_buk_pen" placeholder="No Bukti Penerimaan" value="<?= $brg['no_buk_pen']; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">Tanggal Bukti Penerimaan</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control mb-1 datepicker" data-provide="datepicker" id="tgl_buk_pen" name="tgl_buk_pen" placeholder="Tanggal Bukti Penerimaan" autocomplete="off" value="<?= $brg['tgl_buk_pen']; ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="input-group mb-3">
                        <select class="custom-select" id="inputGroupSelect02" name="status">
                            <option value="<?= $brg['status']; ?>" selected><?= $brg['status']; ?></option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control mb-1" id="ket" name="ket" placeholder="Keterangan" value="<?= $brg['ket']; ?>">
                </div>
            </div>
    </div>
